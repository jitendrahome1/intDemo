...
class AppDelegate: UIResponder, UIApplicationDelegate {
	...
	func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
		...
		UINavigationBar.appearance().tintColor = UIColor.whiteColor() // UIColorRGB(19, g: 150, b: 199)
	...
	func pushToDashboard() {
		let mainViewController = mainStoryboard.instantiateViewControllerWithIdentifier("MainNavigationController") as! UINavigationController
		let rightViewController = mainStoryboard.instantiateViewControllerWithIdentifier(String(MenuViewController)) as! MenuViewController
		...
		UIApplication.sharedApplication().windows.first!.rootViewController = slideMenuController
	}
	...
	lazy var managedObjectModel: NSManagedObjectModel = {
		...
		let modelURL = NSBundle.mainBundle().URLForResource("Greenply", withExtension: "momd")!
